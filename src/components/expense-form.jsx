...
export function ExpenseForm({
  ...
  // Calcular total de despesas recorrentes
  useEffect(() => {
    if (isRecurring && watchAmount && watchFrequency && watchDueDate && watchEndDate) {
  ...
  }, [watchAmount, watchFrequency, watchDueDate, watchEndDate, isRecurring])
  ...
  const onSubmit = (data) => {
    ...
    console.log("Despesa adicionada:", expenseData)
    onClose()
  }
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                <Label className="text-sm font-medium">Lançamento Futuro</Label>
